...
async def init():
    ...
    LOGGER("ميــوزك حمو").info("تم تحميل الاضافات ...✓")
    await userbot.start()
    await Zelzaly.start()
    try:
        await Zelzaly.stream_call("https://telegra.ph/file/95d22359f7f37bceab69b.jpg")
    except NoActiveGroupCall:
        LOGGER("ميــوزك حمو").info(
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("ميــوزك حمو").info("جارِ ايقاف بوت الميوزك . . .")
